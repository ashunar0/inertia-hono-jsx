...
1. In npm, open the package settings for `@ts-76/inertia-hono-jsx`.
2. Add a trusted publisher:
   - Provider: GitHub Actions
   - Owner: `ts-76`
   - Repository: `inertia-hono-jsx`
   - Workflow filename: `release.yml`
3. Update `package.json` to the next version.
4. Commit the version change and push a matching tag:
...
The release workflow installs dependencies, builds the package, and publishes it to npm.
